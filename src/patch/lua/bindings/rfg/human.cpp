...
namespace lua::bindings::rfg {
    ...
    void bind_human_flags(sol::state_view& lua) {
        ...
        auto human_flags =
            types.new_usertype<::rfg::human_flags>("human_flags", sol::no_constructor);
    ...
    void bind_human(sol::state_view& lua) {
        ...
        auto human = types.new_usertype<::rfg::human>(
            "human", sol::no_constructor, sol::base_classes, sol::bases<::rfg::object>());
