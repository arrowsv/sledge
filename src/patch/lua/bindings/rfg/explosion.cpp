...
namespace rfg {
    void bind_explosion_info(sol::state_view& lua) {
        ...
        auto explosion_info =
            table.new_usertype<rfg::explosion_info>("explosion_info", sol::no_constructor);
        explosion_info["name"] =
            sol::property([](rfg::explosion_info& self) { return std::string(self.m_name); });
        ...
        explosion_info["human_min_damage_hitpoints"] =
            &rfg::explosion_info::m_human_min_damage_hitpoints;
        explosion_info["human_max_damage_hitpoints"] =
            &rfg::explosion_info::m_human_max_damage_hitpoints;
        explosion_info["vehicle_min_damage_hitpoints"] =
            &rfg::explosion_info::m_vehicle_min_damage_hitpoints;
        explosion_info["vehicle_max_damage_hitpoints"] =
            &rfg::explosion_info::m_vehicle_max_damage_hitpoints;
        ...
        explosion_info["player_vehicle_impulse_mult"] =
            &rfg::explosion_info::player_vehicle_impulse_mult;
        ...
        explosion_info["expanding_explosion_duration"] =
            &rfg::explosion_info::expanding_explosion_duration;
        explosion_info["expanding_explosion_delay"] =
            &rfg::explosion_info::expanding_explosion_delay;
