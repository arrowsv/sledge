...
namespace rfg {
    ...
    struct __attribute__((aligned(4))) path_node {
        path_node* next;
        path_node* prev;
        vector pos;
    ...
    struct __attribute__((aligned(8))) human_path_data {
    ...
    struct human_info {
        ...
        float max_speed;
        inventory_item_info* default_equip_item;
        inventory_item_info* default_last_equip_item;
        char* name;
        ...
        int home_district;
        float aim_error_pct;
        foot_ground_effect* foot_effects;
        int num_heads;
    ...
    struct __attribute__((aligned(2))) human_head_morphing {
        int num_targets;
    ...
    struct __attribute__((aligned(4))) human_action_node_data {
    ...
    enum object_hit_location : uint32_t {
        HIT_NONE = 0xFFFFFFFF,
        HIT_GENERAL = 0x0,
        HIT_TORSO = 0x1,
        HIT_PELVIS = 0x2,
    ...
    enum human_rotate_dir {
        ...
        HUMAN_ROTATE_COUNTER_CLOCKWISE = 0x2,
    ...
    struct human_flags {
        ...
        unsigned __int32 ignored_by_ai : 1;
    ...
    struct human : object {
        ...
        __attribute__((aligned(16))) human_spinebend_data spinebend_data;
        ...
        timestamp knockdown_timeout_timestamp;
        human_combat combat;
        timestamp collision_damage_timer;
        float current_collision_damage;
        timestamp do_ragdoll_timestamp;
        timestamp facial_pose_timestamp;
    ...
    static_assert(sizeof(rfg::human) == 0x0CE0);

    REF_FUNC(give_item_from_name,
    ...
    REF_FUNC(give_item_from_inv_item_info,
             void __cdecl(rfg::human* human, const rfg::inv_item_info* info, int count,
                          int ammo_count, int slot, bool add_to_weapon_cabinet,
                          bool demolitions_master_override, bool show_inventory),
