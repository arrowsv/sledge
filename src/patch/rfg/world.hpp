...
namespace rfg {
    ...
    struct __attribute__((aligned(8))) world {
        ...
        char destroyed_object_table[8200]; // hash_table<unsigned int, &hash_uint, 1024, unsigned
                                           // short> destroyed_object_table;
    ...
    // REF_FUNC(get_district_from_position, rfg::district* __cdecl(const rfg::vector* position),
    // 0x78F340);
