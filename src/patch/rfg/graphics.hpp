...
namespace rfg {
    ...
    REF_VAR(g_os_app_active, bool, OFFSET(0x01518591, 0x01519591));
    REF_VAR(g_mouse_visible, bool, OFFSET(0x01ce76ea, 0x01ce86ea));
    REF_VAR(g_mouse_using_relative_movement, bool, OFFSET(0x01ce76e8, 0x01ce86e8));
}