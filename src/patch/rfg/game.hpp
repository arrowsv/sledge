...
namespace rfg {
    ...
    REF_FUNC(get_alert_level, rfg::alert_level __cdecl(), OFFSET(0x75D580, 0x0075d610));
    REF_FUNC(set_alert_level, void __cdecl(rfg::alert_level alert_level),
             OFFSET(0x7AA6B0, 0x007aa740));

    REF_FUNC(get_alert_level_cap,
             void __cdecl(rfg::alert_level* minimum, rfg::alert_level* maximum),
